                        ...
                        <div class="products-sort-order dropdown">
                            <div class="ShopDropdown">
                                ...
                                <div class="ShopDropdown-content">
                                        <a href="{{ url('/new-category',['slug'=>$myCategory->slug,'sort'=>"asc"]) }}">Name, A to Z</a>
                                        <a href="{{ url('/new-category',['slug'=>$myCategory->slug,'sort'=>"desc"]) }}">Name, Z to A</a>
                                        <a href="{{ url('/new-category',['slug'=>$myCategory->slug,'sort'=>"price:low-to-high"]) }}">Price, Low to High</a>
                                        <a href="{{ url('/new-category',['slug'=>$myCategory->slug,'sort'=>"price:high-to-low"]) }}">Price, High to Low</a>
                                </div>
                            </div>
                        </div>
                    </div>
