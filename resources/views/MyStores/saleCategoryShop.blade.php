                        ...
                        <div class="products-sort-order dropdown">
                            <div class="ShopDropdown">
                                ...
                                <div class="ShopDropdown-content">  
                                    <a href="{{ url('/sale-category',['slug'=>$myCategory->slug,'sort'=>"asc"]) }}">Name, A to Z</a>
                                    <a href="{{ url('/sale-category',['slug'=>$myCategory->slug,'sort'=>"desc"]) }}">Name, Z to A</a>
                                    <a href="{{ url('/sale-category',['slug'=>$myCategory->slug,'sort'=>"price:low-to-high"]) }}">Price, Low to High</a>
                                    <a href="{{ url('/sale-category',['slug'=>$myCategory->slug,'sort'=>"price:high-to-low"]) }}">Price, High to Low</a>
                                </div>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="product-item">
                        ...
                        <div class="caption">
                           <div class="inner">
                              ...
                              <div>
                                 <p class="price">  <span class="price-new"  id="amount_{{$product->id}}"></span> 
                                 <span class="price-old">
                                 <input type="hidden" id="regular_{{$product->id}}" value="{{ $product->price1_weight }}">    
                                    $ {{ $product->price1_weight }}</span> 
                                    </p>
                                 <div class="box-label">
                                     
                                    <div><span class="pro-label sale">
                                    <input type="hidden" id="discount_{{$product->id}}" value="{{ $product->discount }}">
