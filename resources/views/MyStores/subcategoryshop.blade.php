...
<div class="breadcrumbs">
         <ul class="breadcrumb">
            ...
            <li>
                <a href="{{ url('/shop',$selectCategory->slug) }}">
   ...
   <div class="row">
      <aside id="column-left" class="col-sm-3 col-xs-12">
         <div class="col-order-inner">
            ...
            <!--   </div>-->
            <!--   <ul>-->
            <!--   <?php $subcategoryTypes = App\Models\SubCategoryType::where('subcategory_id',$selectSubcategory->id)->orderBy('id','ASC')->get();?>-->
            <!--   @foreach( $subcategoryTypes as $subcategoryType )-->
            <!--      <li>  -->
                                                               			
            <!--      <a href="{{ route('subcategorytype_shop',['categorySlug'=>$selectCategory->slug,'subcategorySlug'=>$selectSubcategory->slug,'subcategorytypeSlug'=>$subcategoryType->slug]) }}">{{ $subcategoryType->subcategory_type }}</a>-->
            <!--      </li>-->
            <!--   @endforeach-->
            <!--   </ul>-->
            <!--</div>-->
                        ...
                        <div class="products-sort-order dropdown">
                            <div class="ShopDropdown">
                                ...
                                <div class="ShopDropdown-content">
                                        <a href="{{ route('subcategory_sortShop',['categorySlug'=>$selectCategory->slug,'subcategorySlug'=>$selectSubcategory->slug,'sort'=>"asc"]) }}">Name, A to Z</a>
                                        <a href="{{ route('subcategory_sortShop',['categorySlug'=>$selectCategory->slug,'subcategorySlug'=>$selectSubcategory->slug,'sort'=>"desc"]) }}">Name, Z to A</a>
                                        <a href="{{ route('subcategory_sortShop',['categorySlug'=>$selectCategory->slug,'subcategorySlug'=>$selectSubcategory->slug,'sort'=>"price:low-to-high"]) }}">Price, Low to High</a>
                                        <a href="{{ route('subcategory_sortShop',['categorySlug'=>$selectCategory->slug,'subcategorySlug'=>$selectSubcategory->slug,'sort'=>"price:high-to-low"]) }}">Price, High to Low</a>
                                </div>
                            </div>
                        </div>
                    </div>
