...
<div class="breadcrumbs">
         <ul class="breadcrumb">
            ...
            <li><a href="javascript:void(0)">Best Selling Products</a></li>
         </ul>
</div>
         ...
         <div class="custom-category">
            <div class="tool-bar">
               <div class="row">
                  ...
                  <div class="col-md-3 col-xs-6" style="display: flex;justify-content: end;">
                        ...
                        <div class="products-sort-order dropdown">
                            <div class="ShopDropdown">
                                ...
                                <div class="ShopDropdown-content">
                                        <a href="{{ url('/best-selling-products',['sort'=>"asc"]) }}">Name, A to Z</a>
                                        <a href="{{ url('/best-selling-products',['sort'=>"desc"]) }}">Name, Z to A</a>
                                        <a href="{{ url('/best-selling-products',['sort'=>"price:low-to-high"]) }}">Price, Low to High</a>
                                        <a href="{{ url('/best-selling-products',['sort'=>"price:high-to-low"]) }}">Price, High to Low</a>
                                </div>
                            </div>
                        </div>
                    </div>
