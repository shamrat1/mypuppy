         ...
         <ul class="breadcrumb">
            ...
            <li>
                <a href="{{ route('shop_category',$selectCategory->slug) }}">
                        ...
                        <?php $selectCategory= App\Models\Category::findOrFail($selectCategory->id); ?>
                        ...
                        <div class="products-sort-order dropdown">
                            <div class="ShopDropdown">
                                ...
                                <div class="ShopDropdown-content">
                                    <a href="{{ route('subcategorytype_sortShop',['categorySlug'=>$selectCategory->slug,'subcategorySlug'=>$selectSubCategory->slug,'subcategorytypeSlug'=>$selectSubCategorytype->slug,'sort'=>"asc"]) }}">Name, A to Z</a>
                                    <a href="{{ route('subcategorytype_sortShop',['categorySlug'=>$selectCategory->slug,'subcategorySlug'=>$selectSubCategory->slug,'subcategorytypeSlug'=>$selectSubCategorytype->slug,'sort'=>"desc"]) }}">Name, Z to A</a>
                                    <a href="{{ route('subcategorytype_sortShop',['categorySlug'=>$selectCategory->slug,'subcategorySlug'=>$selectSubCategory->slug,'subcategorytypeSlug'=>$selectSubCategorytype->slug,'sort'=>"price:low-to-high"]) }}">Price, Low to High</a>
                                    <a href="{{ route('subcategorytype_sortShop',['categorySlug'=>$selectCategory->slug,'subcategorySlug'=>$selectSubCategory->slug,'subcategorytypeSlug'=>$selectSubCategorytype->slug,'sort'=>"price:high-to-low"]) }}">Price, High to Low</a>
                                </div>
                            </div>
                        </div>
                    </div>
