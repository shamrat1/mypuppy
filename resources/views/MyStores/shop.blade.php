                        ...
                        <div class="products-sort-order dropdown">
                            <div class="ShopDropdown">
                                ...
                                <div class="ShopDropdown-content">
                                        ...
                                        <a href="{{ url('/sort-shop',['sort'=>"asc"]) }}">Name, A to Z</a>
                                        <a href="{{ url('/sort-shop',['sort'=>"desc"]) }}">Name, Z to A</a>
                                        <a href="{{ url('/sort-shop',['sort'=>"price:low-to-high"]) }}">Price, Low to High</a>
                                        <a href="{{ url('/sort-shop',['sort'=>"price:high-to-low"]) }}">Price, High to Low</a>
