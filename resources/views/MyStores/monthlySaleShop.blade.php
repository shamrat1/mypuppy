         ...
         <div class="col-order-inner">
            <div class="panel panel-default pt-filter">
               <div class="layered">
                  ...
                  <div class="filter-attribute-container padding">
                        ...
                        <div class="products-sort-order dropdown">
                            <div class="ShopDropdown">
                                ...
                                <div class="ShopDropdown-content">
                                        ...
                                        <a href="{{ url('/monthly-sale',['sort'=>"asc"]) }}">Name, A to Z</a>
                                        <a href="{{ url('/monthly-sale',['sort'=>"desc"]) }}">Name, Z to A</a>
                                        <a href="{{ url('/monthly-sale',['sort'=>"price:low-to-high"]) }}">Price, Low to High</a>
                                        <a href="{{ url('/monthly-sale',['sort'=>"price:high-to-low"]) }}">Price, High to Low</a>
