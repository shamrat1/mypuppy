...
<div class="content-wrapper">
   ...
   <section class="content">
      <div class="bg-dark-gray border rounded border-dark mb-3 p-3"><a href="{{ url('service-timings/create',$myStoreId->id) }}" class="pull-right btn btn-success text-uppercase"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Service Timing</a></div>
      <div class="card">
         <div class="card-header">
            <h3 class="text-center m-3 p-3 bg-primary text-light text-uppercase"><i class="fa fa-clock"></i> Service Timings</h3>
         </div>
         <div class="card-header">
                                 ...
                                 <div class="row mb-5">
                                  ...
                                  <div class="col-md-10">
                                      <strong>Select Store:</strong>
                                            ...
                                            <?php  $stores  = App\Models\ServiceLocation::orderBy('store_name','ASC')->get(); ?>
