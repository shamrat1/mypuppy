...
<div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ url('/data') }}"><i class="zmdi zmdi-home"></i> Products</a></li>
    ...
    <section class="content">
        <div class="container-fluid">  
            <a href="{{ url('/pet-details-admin') }}" class=" ml-5 btn btn-danger "><i class="fas fa-chevron-left"></i> Back</a>        
            <div class="bg-dark-gray border rounded border-dark mt-3 mb-3 p-3">
                
                <h3 class="text-center bg-info text-light text-uppercase">
                    <i class="fa fa-plus-circle" aria-hidden="true"></i>  Pet Gallery
                </h3>
                      ...
                      <div class="col">
                        <div class="card text-center" style="width: 170px;height:220px;border: 2px solid gray;">
                            ...
                            <div class="card-header">
                             ...
                             <div class="card-body">
                                <img src="/storage/{{ $data->image_path }}" class="imgStyle"  alt="">
                            </div>
                        ...
                        <div class="card text-center" style="width: 170px;height:220px;border: 2px solid gray;">
                            ...
                            <div class="card-body">
                             @if($data->image_path1!="")
                               ...
                               <img src="/storage/{{ $data->image_path1 }}"  class="imgStyle"  alt="">
                               @else
                        ...
                        <div class="card text-center" style="width: 170px;height:220px;border: 2px solid gray;">
                            ...
                            <div class="card-body">
                             @if($data->image_path2!="")
                               ...
                               <img src="/storage/{{ $data->image_path2 }}" class="imgStyle"   alt="">
                               @else
                        ...
                        <div class="card text-center" style="width: 170px;height:220px;border: 2px solid gray;">
                            ...
                            <div class="card-header">
                             ...
                             @if($data->image_path3!="")
                               ...
                               <img src="/storage/{{ $data->image_path3 }}" class="imgStyle"   alt="">
                               @else
                ...
                <form action="{{ route('gallery_update',$data->id) }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                       ...
                       <div class="modal-content">
                         ...
                         <div class="modal-header">
                           ...
                           <h5 class="modal-title" id="exampleModalLongTitle">Update {{ $data->pet_name }} Image</h5>
                         ...
                         <div class="modal-body">
                            ...
                            <div class="form-group form-control-lg">
                             ...
                             <input type="file" name="image_path" value="asset('storage/'{{ $data->image_path }})"  class="form-control">
                                  <img src="asset('storage/'{{ $data->image_path }})" id="previewImg" alt="">
                      ...
                      <form action="{{ route('petGallery_update',$data->id) }}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                       ...
                       <div class="modal-content">
                         ...
                         <div class="modal-header">
                           ...
                           <h5 class="modal-title" id="exampleModalLongTitle">Update {{ $data->pet_name }} Gallery Image-1</h5>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                       ...
                       <div class="modal-content">
                         ...
                         <div class="modal-header">
                           ...
                           <h5 class="modal-title" id="exampleModalLongTitle">Update {{ $data->pet_name }} Gallery Image-2</h5>
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                       ...
                       <div class="modal-content">
                         ...
                         <div class="modal-header">
                           ...
                           <h5 class="modal-title" id="exampleModalLongTitle">Update {{ $data->pet_name }} Gallery Image-3</h5>
