    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="bg-dark-gray border rounded border-dark mb-3 p-3">
                ...
                <a href="{{ url('animal-types/create') }}" class="pull-right btn btn-success text-uppercase">
            ...
            <div class="card">
                ...
                <div class="card-header">
                        <h3 class="text-center m-3 p-3 bg-primary text-light text-uppercase"><b>𓃩</b> Animal Type</h3>
                </div>
            ...
            <?php $animalTypes = App\Models\AnimalType::orderBy('id','DESC')->get();
                            
            ?>

                        <tbody>

                @foreach ($animalTypes as $data )
                ...
                <form action="{{ url('/update-animal-type') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <input type="hidden" name="animal_id" value="{{$data->id}}" required>
                                <div class="row ml-5" >
                                    <div class="col-md-5">
                                      <strong>Store Name:</strong>
                                        <input type="text" name="animal_name" value="{{ $data->animal_name }}" class="form-control"  placeholder="Enter Store Name">
                                    </div>
