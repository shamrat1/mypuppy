                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Our Service Location</li>
        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-header">
                        <h3 class="text-center m-3 p-3 bg-primary text-light text-uppercase"><i class="fa fa-map-marker"></i> Our Service Location</h3>
                </div>
            ...
            <?php 
                    $locations = App\Models\ServiceLocation::where('user_id',$partner->user_id)->get();
             ?>
                            ...
                            <tr>
                                ...
                                <td class="project-actions">
                                    <a href="#logo_{{ $data->id }}" data-toggle="modal"
                                            class="btn btn-sm rounded-pill btn-outline-success"  title="Edit Service Location" ><i class="far fa-edit" aria-hidden="true"> Edit</i></a></li>  
                                </td>
