...
<html lang="en">
   ...
   @include('layouts.headContent')
         ...
         <body class="product-category" cz-shortcut-listen="true" style="padding-top: 0px;">
         <link href="{{ asset('catalog/view/theme/tt_safira_marketplace3/stylesheet/plaza/category/filter.css') }}" type="text/css" rel="stylesheet" media="screen" />
         <!-- Sticky Menu -->
                              ...
                              <div class="box-inner-inner">
                                 ...
                                 <div class="col-cart">
                                    <div class="inner">
                                       ...
                                       <span class="txt-count">{{ $wishCount }}
                                       </span> 
                                       @endauth
                                       @endif
                                       </a>
...
<footer class="pt-5">
            ...
            <div class="footer-middle">
               <div class="container">
                  <div class="footer-custom-links">
                     ...
                     <li><a href="{{ route('shop_category',$FooterCategory->slug) }}" style="text-transform:uppercase;">{{ $FooterCategory->category_name }}</a></li>
                     @endforeach
                  </div>
                  <div class="payment">
          ...
          <script src="{{ asset('js/productLayout.js') }}"></script>
