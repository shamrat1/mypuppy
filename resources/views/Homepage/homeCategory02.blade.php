...
<div class="products-container nav-style-2" id="deskProdsGrid02">
   <?php $showCategory=App\Models\Category::findOrFail(2); ?>
      ...
      <div class="box-large-image">
         ...
         <div class="col col-muti-items">
            <div class="swiper-viewport">
               <div class="swiper-container single-slides-401">
                  <div class="swiper-wrapper">

                  <?php
                           $products = App\Models\Product::query()->where('category','LIKE', 2)
                                       ->orderBy('name','ASC')
                                       ->get();
                           ?>
                     ...
                     <div class="product-thumb transition swiper-slide">
                        <div class="grid-style">
                           <div class="product-item" data-countdown="countdown-title-box-401-32">
                           <div class="image ">
               ...
               <div class="swiper-pager">
                  <div class="swiper-button-next swiper-button-next-401"></div>
                  <div class="swiper-button-prev swiper-button-prev-401"></div>
               </div>
            </div>
         </div>
      </div>
      <script>
         var product_slides_404 = $(".single-slides-401").swiper({
             spaceBetween:0,
                                                             nextButton: '.swiper-button-next-401',
             prevButton: '.swiper-button-prev-401',
                                     speed:  500 ,
         preloadImages: false,
         lazyLoading: true,
