...
<div class="products-container nav-style-2" id="deskProdsGrid03">
   <?php $showCategory=App\Models\Category::findOrFail(7); ?>
      ...
      <div class="box-large-image">
            ...
            <div class="image-content">
               <div class="pt-block">
                  <div class="image">
                     ...
                     <img src="{{$showCategory->image_path}}" class="myImageSize"  title="{{ $showCategory->category_name }}" alt="{{ $showCategory->category_name }}" />
                     </a>
                  </div>
               </div>
            </div>
         ...
         <div class="col col-muti-items">
            <div class="swiper-viewport">
               <div class="swiper-container single-slides-405">
                  <div class="swiper-wrapper">

                  <?php
                           $products = App\Models\Product::query()->where('category','LIKE', 7)
                                       ->orderBy('name','ASC')
                                       ->get();
                           ?>
                     ...
                     <div class="product-thumb transition swiper-slide">
                        <div class="grid-style">
                           <div class="product-item" data-countdown="countdown-title-box-405-32">
                           <div class="image ">
                                    ...
                                    <div class="quickview">
                                       <a href="{{url('/product-details/'.$product->slug)}}" role="button" title="Quick View" class="button-quickview"><span>Quick View</span></a>
                                    </div>
                                 </div>
                                 <div class="caption">
                                    <div class="inner">
                                       ...
                                       <p class="manufacture-product">
                                          <a href="{{ route('shop_category',$showCategory->slug) }}">{{ $showCategory->category_name }}</a>
                                       </p>
               ...
               <div class="swiper-pager">
                  <div class="swiper-button-next swiper-button-next-405"></div>
                  <div class="swiper-button-prev swiper-button-prev-405"></div>
               </div>
            </div>
         </div>
      </div>
      <script>
         var product_slides_404 = $(".single-slides-405").swiper({
             spaceBetween:0,
                                                             nextButton: '.swiper-button-next-405',
             prevButton: '.swiper-button-prev-405',
                                     speed:  500 ,
         preloadImages: false,
         lazyLoading: true,
