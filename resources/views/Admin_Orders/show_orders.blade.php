...
<!-- Main content -->
    <section class="content">
		<a style="margin-left: 300px" href="{{url('dashboard')}}" class=" mb-3 btn btn-primary btn-outline-success"><i class="fas fa-arrow-left"></i> Back </a>
		
		<div class="btn-group mb-3" style="float: right;margin-right:100px" role="group" aria-label="Basic example">
			<button type="button" class="btn btn-success" onclick="printDiv('pdf','Title')"><i class="fa fa-print" aria-hidden="true"></i> Print Invoice</button>
...
<div class="container " id="pdf">
    ...
    <div class="row mt-3" style="margin-left: 250px">
        <div class="col-xs-12">
