   ...
   <section class="content">
      <div class="card">
         <div class="card-header">
            <h3 class="text-center m-3 p-3 bg-primary text-light text-uppercase"><i class="fab fa-blogger"></i> Our Servicess</h3>
         </div>
         <div class="card-header">
         ...
         <div class="card-body p-0" id="tab">
            <table id="myTable" class="table table-striped projects">
               ...
               <?php $services = App\Models\Service::orderBy('id','ASC')->get();
                  ?>
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="project_progress">
                        <img src="{{$service->image_path}}" style="width: 100px;height: 100px;" alt="">
                     </td>
                     <td class="project-actions">
                        <ul style="list-style:none;">
                           ...
                           <li style="padding-top:5px"><a href="#banner_{{ $service->id }}" data-toggle="modal"
                  ...
                  <form action="{{ route('update_service_details') }}" method="POST" enctype="multipart/form-data">
                     @csrf
                     <!-- Modal  2 #logo-->
                  ...
                  <form action="{{ route('update_service_details') }}" method="POST" enctype="multipart/form-data">
                     @csrf
                     <!-- Modal  2 #logo-->
                     <div class="modal fade" id="banner_{{ $service->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                                 <h5 class="modal-title" id="exampleModalLongTitle">Update {{ $service->service_name }} Banner</h5>
                                 <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                 <span aria-hidden="true">&times;</span>
                                 </button>
                              </div>
                              <div class="modal-body">
                                 ...
                                 <div class="form-group form-control-lg text-left">
                                    ...
                                    <img src="{{ asset($service->image_path) }}" id="previewImg" style="width: 100px;height:100px" alt="">
                                    @endif
                                 </div>
                              </div>
                              <br><br>
