         ...
         <div class="row mb-2">
            ...
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Online Dog Training</li>
               </ol>
            </div>
         </div>
      </div>
   ...
   <section class="content">
      <div class="card">
         <div class="card-header">
            <h3 class="text-center m-3 p-3 bg-primary text-light text-uppercase"><i class="fa fa-info-circle"></i> Online Dog Training</h3>
         ...
         <div class="card-body p-0" id="tab">
            ...
            <table id="myTable" class="table table-striped projects">
               ...
               <tbody>
                  ...
                  <?php $myPoint = App\Models\Point::where('service_id',"10")->orderBy('id','asc')->get();  
                   $i= 1;
                  ?>
                  ...
                  @endforeach
                  <?php $cards = App\Models\ImgInfoCard::where('service_id',"10")->orderBy('id','asc')->get();  
                  $i=5;
                  ?>
                  ...
                  <?php $myPointOnline = App\Models\Point::where('service_id',"20")->orderBy('id','asc')->get();  
                   $i= 1;
                  ?>
                  ...
                  <? $myTestimonial1=App\Models\Testimonial::findOrFail(2); ?>
                  <tr>
                      <td>
                        #
                     </td>
                  ...
                  <tr>
                      <? $myTestimonial2=App\Models\Testimonial::findOrFail(3); ?>
                  <tr>
                      <td>
                        #
                     </td>
            ...
            <!-- Button trigger modal for all the button -->
                  <form action="{{ route('update_topic_dog_training') }}" method="POST" enctype="multipart/form-data">
                     @csrf
                     <!-- Modal  2 #logo-->
                     <div class="modal fade" id="update_OnlineTopic" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                           <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <div class="modal-body">
                                 ...
                                 <div class="form-group form-control-lg text-left">
                                    ...
                                    <textarea name="topic1" class="summernoteTopic1" required>{{ $onlineStore->topic }}</textarea>
                                 </div>
                              </div>
                              <br><br>
                              <div class="modal-footer">
