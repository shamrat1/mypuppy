...
<style>
   ...
   background-image: url(images/newrabbit-090717-hero-1440w-418h-d.png);
   ...
   background-image: url(images/whattobuyrabbit-090717-image-520w-285h-d.png);
   opacity: 0.65;
   border: solid 5px #fff;
   }
   .background-img-whattoknowfish-hero-container {
   background-image: url(images/whattoknowrabbit-090717-image-520w-285h-d.png);
   opacity: 0.65;
   border: solid 5px #fff;
   }
   ...
   .background-img-newsaltwaterfish-hero-container {
   background-image: url(images/rabbitBanner.jpg);
   background-repeat: no-repeat;
   background-size: cover;
   background-position: center fixed;
   max-width: 100%!important;
...
<div class="container full-width">
   <div class="row background-img-newsaltwaterfish-hero-container text-center" id="rabbit-hero">
      <div class="col-2">&nbsp;</div>
      <div class="col-8 background-img-newsaltwaterfish-hero-content col-center block">
         <div class="row padding-xlg">
            <h1 class="white spacer-sm-top spacer-sm-bottom">Bringing home your new rabbit</h1>
            <p class="white padding-left-lg padding-right-lg"><strong>Discover everything you need to keep your new rabbit happy & healthy.</strong></p>
         </div>
      </div>
      <div class="col-2">&nbsp;</div>
   </div>
   <!--Mob Bird hero-->
         <div  id="rabbit-hero-mob"  class="background-img-newsaltwaterfish-hero-container">
...
<div class="container bg-white"  id="animalType">
   <div class="age_tabs_wrapper triangle maazAlignDesk">
      <div class="age_content_container">
         <p class="animal_type_label"><strong>Select Type</strong></p>
         <div class="age_nav_container">
            <ul class="age_nav">
               <li class="margin-bottom-none age-label-navigation-tab-2 rounded-top-left rounded-bottom-left"><a class="active" href="#"><span class="icon-check-white spacer-xsm-right"></span>Rabbit</a></li>
               <li class="margin-bottom-none age-label-navigation-tab-2 rounded-top-right rounded-bottom-right"><a href="#">Guinea Pig</a></li>
               <li class="margin-bottom-none age-label-navigation-tab-2 rounded-top-left rounded-bottom-left"><a href="#">Hamster</a></li>
               <li class="margin-bottom-none age-label-navigation-tab-2 rounded-top-right rounded-bottom-right"><a href="#">Other</a></li>
            </ul>
         </div>
      </div>
   </div>
...
<div class="container bg-white  spacer-sm-bottom">
   <div class="container" id="rabbitGuides">
      <h2 class="text-center pb-3">Rabbit Guides</h2>
         ...
         <div class="col-6 background-img-whattobuyfish-hero-container all-rounded-corners-dropshadow border-medium padding-sm text-center">
            <div class="background-img-whattobuyfish-hero-content">
               <div class="col-12 text-center">
                  ...
                  <p class="white">From food to fun, explore top products to welcome—and pamper—your new rabbit.</p>
            ...
            <div class="background-img-whattoknowfish-hero-content">
               <div class="row">
                  <div class="col-12 text-center">
                     ...
                     <p class="white">The best articles and videos from our MPMP experts to help you care for your rabbit.</p>
   ...
   <!--Mobile-->
   <div class="container" id="rabbitGuides-mob">
      <h2 class="text-center pb-3">Rabbit Guides</h2>
      <div class="row services-row-md text-center spacer-md-bottom">
