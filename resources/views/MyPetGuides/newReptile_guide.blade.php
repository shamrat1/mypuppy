...
<style>
   ...
   background-image: url(images/newreptile-091217-hero-1440w-418h-d.jpg);
   ...
   background-image: url(images/wtbreptile-091217-image-520w-285h-d.jpg);
   background-size:cover!important;
   opacity: 0.65;
   border: solid 5px #fff;
   }
   .background-img-whattoknowfish-hero-container {
   background-image: url(images/wtkreptile-091217-image-520w-285h-d.jpg);
   background-size:cover!important;
   opacity: 0.65;
   border: solid 5px #fff;
   }
   ...
   .background-img-newsaltwaterfish-hero-container {
   background-image: url(images/myReptile.jpg);
   background-repeat: no-repeat;
   background-size: cover;
   background-position: center fixed;
   max-width: 100%!important;
...
<div class="container full-width">
   <div class="row background-img-newsaltwaterfish-hero-container text-center" id="reptile-hero">
   <div class="col-2">&nbsp;</div>
   <div class="col-8 background-img-newsaltwaterfish-hero-content col-center block" >
      <div class="row padding-xlg">
         <h1 class="white spacer-sm-top spacer-sm-bottom">Bringing home your new reptile</h1>
         <p class="white padding-left-lg padding-right-lg"><strong>Discover everything you need to keep your new reptile happy & healthy.</strong></p>
      </div>
   </div>
   <div class="col-2">&nbsp;</div>
</div>
...
<!--Mob Bird hero-->
   <div class="container full-width">
         <div  id="reptile-hero-mob"  class="background-img-newsaltwaterfish-hero-container">
   <div class="row  text-center">
      <div class="col-12 col-12-sm ">
         <h3 class="white spacer-sm-top spacer-sm-bottom">Bringing home your new reptile</h3>
...
<div class="container bg-white  spacer-sm-bottom">
   <div class="container" id="reptileGuides">
      <h2 class="text-center pb-3">Reptile Guides</h2>
         ...
         <div class="col-6 background-img-whattobuyfish-hero-container all-rounded-corners-dropshadow border-medium padding-sm text-center">
            <div class="background-img-whattobuyfish-hero-content">
               <div class="col-12 text-center">
                  ...
                  <p class="white">From food to fun, explore top products to welcome—and pamper—your new reptile.</p>
            ...
            <div class="background-img-whattoknowfish-hero-content">
               <div class="row">
                  <div class="col-12 text-center">
                     ...
                     <p class="white">The best articles and videos from our Petco experts to help you care for your new reptile.</p>
    ...
    <!--Mobile-->
   <div class="container" id="reptileGuides-mob">
      <h2 class="text-center pb-3">Reptile Guides</h2>
      <div class="row services-row-md text-center spacer-md-bottom">
