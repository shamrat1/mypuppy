...
<div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <div class="container-fluid">
         <div class="row mb-2">
            <div class="col-sm-6">
               <h1>New Cat Pet Guide</h1>
            </div>
            <div class="col-sm-6">
               <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item"><a href="{{ url('/') }}">Home</a></li>
                  <li class="breadcrumb-item"><a href="{{ url('/new-pet-guides-admin') }}">New Pet Guides</a></li>
                  <li class="breadcrumb-item active">New Cat Pet Guide</li>
               </ol>
            </div>
         </div>
      </div>
   ...
   <section class="content">
      <div class="card">
         <div class="card-header">
            <h3 class="text-center m-3 p-3 bg-primary text-light text-uppercase"><i class="fa fa-info-circle"></i>New Cat Pet Guide</h3>
         ...
         <div class="card-body p-0" id="tab">
            ...
            <table id="myTable" class="table table-striped projects">
               ...
               <tbody> 
                  ...
                  <?php $myPoint = App\Models\Point::where('service_id',"12")->orderBy('id','asc')->get();  
                   $i= 0;
                  ?>
                  ...
                  <?php $cards = App\Models\ImgInfoCard::where('service_id',"12")->orderBy('id','asc')->get();  
                  $i=6;
                  ?>
