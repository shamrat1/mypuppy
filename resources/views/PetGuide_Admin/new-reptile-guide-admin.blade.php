   ...
   <section class="content">
      <div class="card">
         <div class="card-header">
            <h3 class="text-center m-3 p-3 bg-primary text-light text-uppercase"><i class="fa fa-info-circle"></i>New Reptile Pet Guide</h3>
         ...
         <div class="card-body p-0" id="tab">
            ...
            <table id="myTable" class="table table-striped projects">
               ...
               <tbody> 
                  ...
                  <?php $cards = App\Models\ImgInfoCard::where('service_id',"13")->orderBy('id','asc')->get();  
                  $i=1;
                  ?>
